...
Install pre-commit by following the [guide](https://github.com/nholuongut/pre-commit)

Install tflint by following the [guide](https://github.com/terraform-linters/tflint)

Install tfsec by following the [guide](https://github.com/nholuongut/tfsec)

Install tfupdate by following the [guide](https://github.com/nholuongut/tfupdate)
